...
//use exonum_btc_anchoring::ServiceFactory as BtcAnchoringServiceFactory; // FIXME: uncomment when anchoring fixed ECR-3468
...
fn system_service_factory_for_name(name: &str) -> Box<dyn ServiceFactory> {
    match name {
        ...
        //        BTC_ANCHORING_SERVICE => Box::new(BtcAnchoringServiceFactory) as Box<ServiceFactory>, // FIXME: uncomment when anchoring fixed ECR-3468
...
mod tests {
    ...
    #[test]
    #[ignore] // FIXME: temporary ignored until anchoring service is fixed ECR-3468
